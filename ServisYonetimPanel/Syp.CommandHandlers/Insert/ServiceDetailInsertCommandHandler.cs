namespace Syp.CommandHandlers.Insert
{
    ...
    /// <summary>
    /// Defines the <see cref="ServiceDetailInsertCommandHandler"/>.
    /// </summary>
            ...
            : BaseCommandHandler<ServiceDetailInsertCommand, LongCommandResult>
    {
        ...
        /// The Handle.
        /// </summary>
        /// <param name="command">The command <see cref="ServiceDetailInsertCommand"/>.</param>
        ...
        /// <returns></returns>
        public override SimpleResponse Validate(ServiceDetailInsertCommand command)
        {
